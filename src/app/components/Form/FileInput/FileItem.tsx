...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      error: {
        container:
          'bg-red-50 border-red-600 dark:bg-red-500/5 dark:border-red-500/30',
        icon: 'border-red-50 bg-red-500 text-red-50 dark:bg-red-500/5 dark:border-red-500/30 dark:text-red-700',
        deleteButton:
